...
| 3 | Add tracks from playlist | 1.6 | #25 |
| 4 | Contextual empty states | 1.4 | #28 |
| 5 | Import progress indicator | 1.5 | #18 |
| 6 | Skippable onboarding | 1.1 | #29 |
| 7 | Search | 2.1 | #30 |
| 8 | Playlist visual identity | 2.2 | #31 |
